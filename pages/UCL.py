...
# ==========================================
PAGE_TITLE = "2024/25 Champions League Analytics"
PLAYS_TABLE = "v_ucl_plays_data"
MATCHES_TABLE = "ucl_top_flight"
# ⚠️ Using the exact name from your snippet
STANDINGS_TABLE = '"2024_25_uefa_champions_league__league_phase_standings"'
COMPETITION_FILTER = "UEFA Champions League" # ⚠️ Verify this matches your DB (might be 'Champions League')
...
LIMIT 1;
"""
# (Note: Clean sheets query is hard to filter by team efficiently in the subquery without complex logic,
# so we filter post-query or assume 'All Teams' for the metric leader)
