...
PLAYS_TABLE = "v_english_plays_data"           # Table with goals/assists/cards
MATCHES_TABLE = "english_top_flight"           # Table with match scores
STANDINGS_TABLE = '"2024_25_premier_league_standings"' # Table with team list
COMPETITION_FILTER = "Premier League"             # Exact string in "competition" column
# ==========================================
