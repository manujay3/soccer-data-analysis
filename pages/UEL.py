...
# ==========================================
PAGE_TITLE = "2024/25 Europa League Analytics"
PLAYS_TABLE = "v_uel_plays_data"
MATCHES_TABLE = "uel_top_flight"
# ⚠️ Using the exact name from your snippet
STANDINGS_TABLE = '"2024_25_uefa_europa_league__league_phase_standings"'
COMPETITION_FILTER = "Europa League" # ⚠️ Verify this matches your DB (might be 'UEFA Europa League')
