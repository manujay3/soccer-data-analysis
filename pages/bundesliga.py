...
# ==========================================
# ⚙️ CONFIGURATION SECTION (EDIT THIS PER LEAGUE)
# ==========================================
# EXAMPLE: BUNDESLIGA SETTINGS
PAGE_TITLE = "2024/25 Bundesliga Analytics"
PLAYS_TABLE = "v_german_plays_data"           # Table with goals/assists/cards
MATCHES_TABLE = "german_top_flight"           # Table with match scores
STANDINGS_TABLE = '"2024_25_german_bundesliga_standings"' # Table with team list
COMPETITION_FILTER = "Bundesliga"             # Exact string in "competition" column
# ==========================================
